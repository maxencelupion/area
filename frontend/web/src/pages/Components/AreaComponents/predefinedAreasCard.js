...
function PredefinedAreasCard(_services, _actions, _reactions, _width, _height, _listSize) {
  const createPredefinedCard = (cards) => {
    ...
    return {
      ...
      _titleIcon: getServiceIcon(service_action.front_data),
      _actionIcon: getServiceIcon(service_reaction.front_data),
